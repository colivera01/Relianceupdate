...
- Release gates: Apply/reconcile the additive migration, deploy the package, validate storage and cache behavior, complete physical-device replay, and complete the four-role Product Owner replay
