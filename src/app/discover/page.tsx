...
export default function DiscoverPage() {
  ...
  const VendorCard = ({ vendor }: { vendor: Vendor }) => (
    <Card className="w-80 h-[420px] flex-shrink-0 hover:shadow-lg transition-all duration-300 cursor-pointer group border border-gray-200 bg-white vendor-card-hover">
      <div className="relative">
        <div className="h-40 rounded-t-lg relative overflow-hidden gradient-blue-purple">
          ...
          {vendor.featured && (
            <Badge className="absolute top-3 left-3 bg-yellow-500 text-black badge-animate">
              Featured
            </Badge>
          )}
