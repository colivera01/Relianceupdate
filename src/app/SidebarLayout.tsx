    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-white text-[#204080] flex flex-col justify-between border-r border-gray-200">
        ...
        <div className="p-4 flex flex-col gap-3 border-t border-gray-200">
          ...
          <button
            className="mt-4 flex items-center gap-2 border border-blue-700 text-blue-700 px-3 py-2 rounded hover:bg-blue-50 transition-colors font-medium"
          ...
          <button
            className="mt-2 flex items-center gap-2 border border-green-700 text-green-700 px-3 py-2 rounded hover:bg-green-50 transition-colors font-medium"
