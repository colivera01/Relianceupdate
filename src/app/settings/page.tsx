    ...
    <div className="p-6 space-y-6 relative">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            <Checkbox checked={autoApproveUsers} onCheckedChange={(v) => setAutoApproveUsers(!!v)} />
            <InfoIcon tooltip="Automatically approves new user (customer) registrations without manual review." />
      ...
      <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <div className="text-sm text-blue-700 space-y-1">
          ...
          <ul className="list-disc list-inside ml-4 space-y-1">
            ...
            <li><code>PATCH /api/user/profile</code> - Update user profile (name, email, password)</li>
          </ul>
          <p><strong>Settings Data Format:</strong></p>
...
{`{
  ...
  notifyFlaggedReview: boolean,
  weeklySummary: boolean,
  alertVendorDeactivation: boolean,
  alertFailedLogins: boolean,
  ...
  autoLogoutMinutes: number
          ...
          <p><strong>User Profile Update Format:</strong></p>
          <pre className="bg-gray-100 p-2 rounded text-xs mt-2 overflow-x-auto">
{`{
  displayName: string,
  email: string,
  ...
  passwordNew?: string
          ...
          <ul className="list-disc list-inside ml-4 space-y-1">
            <li>Password change requires old password verification</li>
            <li>New password must meet minimum length and complexity requirements</li>
            <li>Email must be unique and valid format</li>
            <li>Numeric fields must be positive integers</li>
          </ul>
