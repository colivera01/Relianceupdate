export default function TermsPage() {
  return (
    <div style={{ maxWidth: 800, margin: '40px auto', fontFamily: 'sans-serif' }}>
      ...
      <p>
        By accessing or using Reliance, you agree to these Terms of Service. Please read them
      ...
      <h3>2. Vendor Responsibility</h3>
      <p>
        Vendors are solely responsible for the services they perform and the content they upload,
        submit, or communicate through the platform. Reliance does not independently verify every
      ...
      <p>
        ...
        data, goodwill, or business interruption arising from platform use. Where permitted, total
        liability is limited to amounts paid by you to Reliance for use of the platform in the
      ...
      <p>
        ...
        You and Reliance waive any right to a jury trial and waive any right to participate in a
