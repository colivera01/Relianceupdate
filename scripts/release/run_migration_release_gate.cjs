...
const commands = [
  ...
  ['node', ['scripts/release/test_sha256_controls.cjs']],
  ['node', ['scripts/release/test_target_spec_generation.cjs']],
  ['node', ['scripts/release/test_malformed_hash_fail_closed.cjs']],
