...
const protectedTests = [
  ...
  "src/lib/review-booking-unique-sqlserver-contract.test.ts",
  "src/lib/review-attribution-aggregates.integration.test.ts",
  "src/lib/public-review-aggregates.test.ts",
