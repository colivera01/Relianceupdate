...
IF OBJECT_ID(N'dbo._prisma_migrations_legacy_20260914_v2', N'U') IS NOT NULL
  THROW 51011, 'Precondition failed: V2 legacy Prisma ledger destination already exists.', 1;
...
EXEC sys.sp_rename N'dbo._prisma_migrations', N'_prisma_migrations_legacy_20260914_v2';
