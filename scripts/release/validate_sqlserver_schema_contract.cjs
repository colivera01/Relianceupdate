...
const CONTRACT = Object.freeze({
  columns: [
    ...
    column("employee_public_media_consent_decisions", "membershipId", "nvarchar", 1000, false),
    column("employee_public_media_consent_decisions", "decision", "nvarchar", 1000, false),
    column("employee_public_media_consent_decisions", "coversLikeness", "bit", 1, false),
    column("employee_public_media_consent_decisions", "coversAudio", "bit", 1, false),
    column("employee_public_media_consent_decisions", "policyVersion", "nvarchar", 1000, false),
    column("employee_public_media_consent_decisions", "decisionHash", "nvarchar", 1000, false),
    column("employee_public_media_consent_decisions", "version", "int", 4, false),
    column("employee_public_media_consent_decisions", "isCurrent", "bit", 1, false, 1),
    column("employee_public_media_notifications", "employeeMembershipId", "nvarchar", 1000, false),
    column("employee_public_media_notifications", "proposalId", "nvarchar", 1000, false),
    column("public_service_video_eligibility", "standingConsentDecisionIdsJson", "nvarchar", -1, true),
  ],
